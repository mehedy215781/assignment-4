...
function renderInterview() {
    ...
    for (let interview of interviewList) {
        ...
        div.innerHTML = `
          ...
          <div>
          <button class=" interview bg-white cursor-pointer border border-[#10B981] p-2 rounded-sm"><span class="text-[#10B981] font-bold">Interview</button>
           
        <button class=" rejected bg-white border cursor-pointer border-[#10B981] p-2 rounded-sm"><span class="text-[#de3a3a] font-bold">Rejected</button>
        </div>
      </div>
        <div class="right ">
